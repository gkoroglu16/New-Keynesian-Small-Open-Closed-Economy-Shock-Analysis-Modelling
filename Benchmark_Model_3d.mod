...
varexo eta_phi eta_z eta_s eta_h eta_ystar
...
//b
%stoch_simul(irf=11, order=1, irf_shocks=(eta_z)) y_hat c_hat i_hat pi_hat ec_hat y_star_hat e_hat ca_hat;

//c
%stoch_simul(irf=10, order=1, irf_shocks=(eta_istar)) y_hat c_hat i_hat pi_hat ec_hat i_star_hat e_hat ca_hat;

//d
%stoch_simul(irf=11, order=1, irf_shocks=(eta_ystar)) y_hat c_hat i_hat pi_hat ec_hat y_star_hat e_hat ca_hat;
