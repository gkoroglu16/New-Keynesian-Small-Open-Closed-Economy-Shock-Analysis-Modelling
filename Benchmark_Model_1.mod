...
//a
stoch_simul(irf=12, order=1, irf_shocks=(epsilon_m_hat), nograph) y_hat c_hat i_hat pi_hat ec_hat e_hat ca_hat;

//b
stoch_simul(irf=12, order=1, irf_shocks=(eta_z), nograph) y_hat c_hat i_hat pi_hat ec_hat epsilon_z_hat e_hat ca_hat;
